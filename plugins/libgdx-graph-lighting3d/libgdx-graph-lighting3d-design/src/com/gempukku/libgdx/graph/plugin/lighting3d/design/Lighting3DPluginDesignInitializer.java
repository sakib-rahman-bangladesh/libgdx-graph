...
import com.gempukku.libgdx.graph.plugin.lighting3d.design.producer.CalculateLightingBoxProducer;
...
import com.gempukku.libgdx.graph.plugin.lighting3d.design.producer.SpotlightBoxProducer;
...
public class Lighting3DPluginDesignInitializer implements PluginDesignInitializer {
    ...
    public void initialize() {
        ...
        UICommonShaderConfiguration.register(new CalculateLightingBoxProducer());
