...
public class ParticlesShadersBoxPart extends VisTable implements GraphBoxPart {
    ...
    public ParticlesShadersBoxPart() {
        ...
        final VisTextButton newShader = new VisTextButton("New Effect");
        newShader.addListener(
                new ChangeListener() {
                    @Override
                    public void changed(ChangeEvent event, Actor actor) {
                        PopupMenu popupMenu = new PopupMenu();
                        for (final GraphShaderTemplate graphShaderTemplate : ParticlesTemplateRegistry.getTemplates()) {
                    ...
                    new ChangeListener() {
                        ...
                        public void changed(ChangeEvent event, Actor actor) {
                            editButton.fire(new RequestGraphOpen(id, "Shader - " + textField.getText(), initialShaderJson,
                                    ParticleEffectGraphType.instance, graphConfigurations));
                        }
                    });
