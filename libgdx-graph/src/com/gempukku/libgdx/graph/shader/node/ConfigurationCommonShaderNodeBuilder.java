...
public abstract class ConfigurationCommonShaderNodeBuilder extends ConfigurationShaderNodeBuilder {
    ...
    protected abstract ObjectMap<String, ? extends FieldOutput> buildCommonNode(boolean designTime, String nodeId, JsonValue data, ObjectMap<String, FieldOutput> inputs, Set<String> producedOutputs,
