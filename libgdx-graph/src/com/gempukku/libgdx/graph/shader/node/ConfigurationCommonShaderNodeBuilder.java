...
public abstract class ConfigurationCommonShaderNodeBuilder extends ConfigurationShaderNodeBuilder {
    ...
    protected abstract Map<String, ? extends FieldOutput> buildCommonNode(boolean designTime, String nodeId, JsonValue data, Map<String, FieldOutput> inputs, Set<String> producedOutputs,
